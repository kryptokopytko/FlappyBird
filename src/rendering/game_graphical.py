import pygame
from rendering.graphical_renderer import GraphicalRenderer
from entities.bird import Bird
from entities.coin import Coin
from entities.powerup import PowerUp
from core.level_generator import LevelGenerator
from core.physics import CollisionDetector
from core.effects import EffectManager
from ai_bots.aggressive_bot import AggressiveBot
from ai_bots.reactive_bot import ReactiveBot
from ai_bots.coin_collector_bot import CoinCollectorBot
from ai_bots.flat_bot import FlatBot
        ...
        for item in self.items:
            ...
            if self.collision_detector.check_bird_item(self.bird, item):
                if isinstance(item, Coin):
                    self.coins += 1
                    self.score += Coin.coins_to_points(self.coins) - Coin.coins_to_points(self.coins - 1)
                    item.collected = True
