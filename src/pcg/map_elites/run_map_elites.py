...
from tests.level_tester import FastLevelTester
...
def save_best_genomes(archive, output_dir="data/map_elites/pcg_levels", n=10):
...
def main():
    ...
    parser.add_argument(
        ...
        "-o",
        type=str,
        default="data/map_elites/archive.json",
    ...
    from tests.level_tester import UltraFastLevelTester
